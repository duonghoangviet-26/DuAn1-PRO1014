...
<head>
    ...
    <style>
        ...
        .form-control[readonly], .form-control[disabled] { background-color: #f8fafc; color: #64748b; }
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="fw-bold text-dark mb-0">Cập Nhật Khách Hàng</h3>
                        <p class="text-muted mb-0">Chỉnh sửa thông tin hồ sơ khách hàng</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card card-form h-100">
                            <div class="card-header-custom">
                                <h5 class="fw-bold text-warning mb-0"><i class="fas fa-user-edit me-2"></i> Thông Tin Cá Nhân</h5>
                            </div>
                            <div class="card-body p-4">
                                <div class="mb-3">
                                    <label class="form-label">Mã Khách Hàng</label>
                                    <input type="text" class="form-control" value="<?= htmlspecialchars($kh['MaCodeKhachHang']) ?>" readonly>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Họ Tên <span class="text-danger">*</span></label>
                                    <input type="text" name="HoTen" class="form-control" value="<?= htmlspecialchars($kh['HoTen']) ?>" required>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Ngày Sinh</label>
                                        <input type="date" name="NgaySinh" class="form-control" value="<?= htmlspecialchars($kh['NgaySinh']) ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="SoGiayTo" class="form-control" value="<?= htmlspecialchars($kh['SoGiayTo']) ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body p-4">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="SoDienThoai" class="form-control" value="<?= htmlspecialchars($kh['SoDienThoai']) ?>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="DiaChi" class="form-control" value="<?= htmlspecialchars($kh['DiaChi']) ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="LoaiKhach" id="LoaiKhach" class="form-select">
                                        ...
                                        <option value="cong_ty" <?= $kh['LoaiKhach'] == 'cong_ty' ? 'selected' : '' ?>>Công ty / Doanh nghiệp</option>
                                    </select>
                                </div>

                                <div id="company-info" style="display: <?= $kh['LoaiKhach'] == 'cong_ty' ? 'block' : 'none' ?>;">
                                    <div class="p-3 bg-light rounded border mb-3">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="TenCongTy" class="form-control form-control-sm" value="<?= htmlspecialchars($kh['TenCongTy'] ?? '') ?>">
                                        </div>
                                        <div>
                                            <label class="form-label small">Mã Số Thuế</label>
                                            <input type="text" name="MaSoThue" class="form-control form-control-sm" value="<?= htmlspecialchars($kh['MaSoThue'] ?? '') ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="GhiChu" class="form-control" rows="2"><?= htmlspecialchars($kh['GhiChu']) ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
