    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h3 class="fw-bold text-dark mb-1">Danh Mục Tour</h3>
                    <p class="text-muted mb-0">Quản lý các loại hình du lịch</p>
                </div>
                <a href="index.php?act=creatDanhMuc" class="btn btn-primary shadow-sm">
                    ...
                    <table class="table table-modern mb-0">
                        ...
                        <tbody>
                            <?php if (!empty($listdanhmuc)): ?>
                                <?php $stt = 1; foreach ($listdanhmuc as $danhmuc): ?>
                                <tr>
                                    <td class="ps-4 fw-bold text-secondary"><?= $stt++ ?></td>
                                    <td>
                                        <span class="fw-bold text-dark"><?= htmlspecialchars($danhmuc['TenDanhMuc']) ?></span>
                                    </td>
                                    <td>
                                        <span class="text-muted"><?= htmlspecialchars($danhmuc['MoTa']) ?></span>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a href="index.php?act=deleteDanhMuc&id=<?= $danhmuc['MaDanhMuc'] ?>" 
                                               ...
                                               onclick="return confirm('Bạn có chắc muốn xóa danh mục này không? Các tour thuộc danh mục này có thể bị ảnh hưởng.')">
