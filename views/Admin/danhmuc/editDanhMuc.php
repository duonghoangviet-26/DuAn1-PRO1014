...
<head>
    ...
    .main-content {
        ...
        .form-control:focus { border-color: #f59e0b; box-shadow: 0 0 0 4px rgba(245, 158, 11, 0.1); } /* Màu cam cho Edit */
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">Chỉnh sửa thông tin danh mục</p>
                </div>
            </div>
                    ...
                    <form action="" method="POST" class="card card-form p-4" novalidate onsubmit="return validateForm(event)">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="TenDanhMuc" id="TenDanhMuc" 
                                   value="<?= htmlspecialchars($dm['TenDanhMuc']) ?>" required>
                        </div>

                        <div class="mb-4">
                            <label for="MoTa" class="form-label">Mô tả</label>
                            <textarea class="form-control" name="MoTa" id="MoTa" rows="4"><?= htmlspecialchars($dm['MoTa']) ?></textarea>
                        </div>
