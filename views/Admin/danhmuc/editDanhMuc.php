            ...
            <form action="" method="POST">
                <!-- <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="MaDanhMuc" id="MaDanhMuc"
                        value="<?= htmlspecialchars($dm['MaDanhMuc']) ?>" required>
                </div> -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="MoTa" id="MoTa"
                        rows="3"><?= htmlspecialchars($dm['MoTa']) ?></textarea>
                </div>
                <button type="submit" class="btn btn-primary" onclick="return alert('Bạn có chắc muốn cập nhật')">Lưu
                    thay đổi</button>
                <a href="index.php?act=listdm" class="btn btn-secondary">Hủy</a>
            </form>
        </div>
