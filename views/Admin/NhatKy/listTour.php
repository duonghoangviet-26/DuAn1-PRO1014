                    ...
                    <div class="col-md-4">
                        <div class="card card-tour h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text text-muted mb-2"><i class="fa-solid fa-barcode"></i> Mã đoàn:
                                    <strong><?= $tour['MaDoan'] ?></strong>
                                </p>
                                <p class="card-text text-muted mb-3"><i class="fa-regular fa-calendar"></i>
                                    <?= date('d/m/Y', strtotime($tour['NgayKhoiHanh'])) ?> -
                                    <?= date('d/m/Y', strtotime($tour['NgayVe'])) ?></p>

                                <div class="d-flex gap-2 mt-3">
                                    <a href="index.php?act=listNhatKy&maDoan=<?= $tour['MaDoan'] ?>"
                                        class="btn btn-outline-primary flex-grow-1 fw-bold">
                                        <i class="fa-solid fa-book-open me-1"></i> Nhật Ký
                                    </a>

                                    <?php if (!empty($tour['MaLichLamViec'])): ?>
                                        <a href="index.php?act=historyDiemDanh&maDoan=<?= $tour['MaDoan'] ?>"
                                            class="btn btn-info flex-grow-1 fw-bold text-white">
