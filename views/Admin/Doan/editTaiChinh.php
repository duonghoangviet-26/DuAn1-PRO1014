...
<body>
    ...
    <div class="content">
        ...
        <form action="index.php?act=updateTC" method="POST" enctype="multipart/form-data" class="shadow p-4 rounded bg-white">
            ...
            <input type="date" name="NgayGiaoDich" class="form-control" value="<?= $data['NgayGiaoDich'] ?>">

            <label>Số tiền</label>
            <input type="number" name="SoTien" class="form-control" value="<?= $data['SoTien'] ?>">

            <label>Hạng mục</label>
            <input type="text" name="HangMucChi" class="form-control" value="<?= $data['HangMucChi'] ?>">
            ...
            <?php if ($data['AnhChungTu']): ?>
                <img src="uploads/<?= $data['AnhChungTu'] ?>" width="120" class="mb-2 rounded border">
            <?php endif; ?>
