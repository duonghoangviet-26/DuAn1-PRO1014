...
<head>
    ...
    <style>
        ...
        .form-control:focus, .form-select:focus { border-color: #10b981; box-shadow: 0 0 0 4px rgba(16, 185, 129, 0.1); } /* Màu xanh lá cho tài chính */
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                    <a href="index.php?act=taichinh&id=<?= $_GET['id'] ?? '' ?>" class="text-secondary me-3 fs-4"><i class="fas fa-arrow-left"></i></a>
                    <div>
                        <h3 class="fw-bold text-dark mb-0">Thêm Giao Dịch</h3>
                        <p class="text-muted mb-0">Ghi nhận thu chi cho đoàn khởi hành</p>
                    </div>
                </div>
            </div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-8">
                        <div class="card card-form h-100">
                            <div class="card-header-custom">
                                <h5 class="fw-bold text-success mb-0"><i class="fas fa-file-invoice-dollar me-2"></i> Thông Tin Giao Dịch</h5>
                            </div>
                            <div class="card-body p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="SoTien" class="form-control" placeholder="Nhập số tiền..." required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="HangMucChi" class="form-control" placeholder="VD: Thanh toán tiền ăn trưa, Thu tiền cọc khách..." required>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Ghi chú thêm</label>
                                    <textarea name="MoTa" class="form-control" rows="3" placeholder="Chi tiết thêm về giao dịch..."></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-form h-100">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="SoHoaDon" class="form-control" placeholder="VD: HD00123">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Ảnh chứng từ (nếu có)</label>
                                    <input type="file" name="AnhChungTu" class="form-control">
                                    <div class="form-text text-muted small">Hỗ trợ ảnh .jpg, .png, .jpeg</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-form p-3 sticky-bottom text-end mt-2">
                    <a href="index.php?act=taichinh&id=<?= $_GET['id'] ?? '' ?>" class="btn btn-cancel me-2">Hủy bỏ</a>
