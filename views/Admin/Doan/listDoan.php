...
<head>
    ...
    <style>
        ...
        .btn-users { background: #dbeafe; color: #2563eb; } .btn-users:hover { background: #2563eb; color: #fff; }
        .btn-finance { background: #d1fae5; color: #059669; } 
        .btn-finance:hover { background: #059669; color: #fff; }
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <a href="index.php?act=taichinh&id=<?= $d['MaDoan'] ?>" class="btn-action btn-finance" title="Quản lý tài chính">
                    ...
                    <nav>
                        <ul class="pagination justify-content-center mb-0">
                            <li class="page-item <?= ($page <= 1) ? 'disabled' : '' ?>">
                                <a class="page-link" href="?act=listDKH&page=<?= $page - 1 ?>"><i class="fas fa-chevron-left"></i></a>
                            </li>
                            ...
                            <li class="page-item <?= ($page >= $totalPage) ? 'disabled' : '' ?>">
                                <a class="page-link" href="?act=listDKH&page=<?= $page + 1 ?>"><i class="fas fa-chevron-right"></i></a>
                            </li>
                        </ul>
                    </nav>
                </div>
