            ...
            <form action="index.php?act=createDKH" method="post">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card card-form h-100">
                            <div class="card-header-custom">
                                <h5 class="fw-bold text-success mb-0"><i class="fas fa-info-circle me-2"></i> Thông Tin
                                    Cơ Bản</h5>
                            </div>
                            <div class="card-body p-4">
                                <div class="mb-4">
                                    <label class="form-label">Chọn Tour <span class="text-danger">*</span></label>
                                    <select name="MaTour" id="MaTour" class="form-select form-select-lg"
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="date" name="NgayKhoiHanh" class="form-control"
                                            value="<?= $tourSelected['NgayBatDau'] ?? ($_POST['NgayKhoiHanh'] ?? '') ?>"
                                            required>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Ngày Về</label>
                                        <input type="date" name="NgayVe" class="form-control"
                                            value="<?= $tourSelected['NgayKetThuc'] ?? ($_POST['NgayVe'] ?? '') ?>"
                                            required>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="DiemTapTrung" class="form-control"
                                        placeholder="VD: 102 Nguyễn Huệ, Q1, TP.HCM" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-form h-100">
                            <div class="card-header-custom">
                                <h5 class="fw-bold text-primary mb-0"><i class="fas fa-users me-2"></i> Nhân Sự & Chỗ
                                </h5>
                            </div>
                            <div class="card-body p-4">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="MaTaiXe" class="form-select">
                                        ...
                                        <?php foreach ($taixe as $tx): ?>
                                            <option value="<?= $tx['MaNhaCungCap'] ?>"><?= $tx['TenLaiXe'] ?>
                                                (<?= $tx['TenNhaCungCap'] ?>)</option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="mb-3">
                ...
                <?php if (!empty($lichtrinh)) : ?>
                    <h5 class="fw-bold text-dark mb-3 mt-4"><i class="fas fa-concierge-bell me-2"></i> Dịch Vụ Theo Lịch
                        Trình</h5>
                            ...
                            <div class="col-md-6">
                                <div class="schedule-item">
                                    <div class="schedule-title">
                                        <i class="far fa-calendar-alt me-1"></i> Ngày <?= $day['NgayThu'] ?>:
                                        <?= htmlspecialchars($day['TieuDeNgay']) ?>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label small text-muted"><i class="fas fa-hotel me-1"></i> Khách
                                            sạn</label>
                                    ...
                                    <div>
                                        <label class="form-label small text-muted"><i class="fas fa-utensils me-1"></i> Nhà
                                            hàng</label>
