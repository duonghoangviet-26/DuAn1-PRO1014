        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                    <a href="index.php?act=listDKH" class="text-secondary me-3 fs-4"><i
                ...
                <div>
                    <a href="index.php?act=editDKH&id=<?= $doan['MaDoan'] ?>"
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card card-info p-4">
                        <h5 class="fw-bold text-primary mb-3"><i class="fas fa-info-circle me-2"></i> Thông Tin Chung
                        </h5>
                        ...
                        <div class="info-row">
                            ...
                            <span
                                class="info-val text-success"><?= date('d/m/Y', strtotime($doan['NgayKhoiHanh'])) ?></span>
                        </div>
                        <div class="info-row">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-val text-end"
                                style="max-width: 60%;"><?= htmlspecialchars($doan['DiemTapTrung']) ?></span>
                        </div>
                    </div>
                        ...
                        <?php foreach ($lichtrinh as $lt) : ?>
                            ...
                            <div class="timeline-day-card">
                                <div class="timeline-header d-flex justify-content-between align-items-center">
                                    ...
                                    <span
                                        class="badge bg-light text-dark border"><?= date('d/m/Y', strtotime($ngaySuDung)) ?></span>
                                </div>
                                <div class="timeline-body">

                                    <div class="row g-2 mb-3 small text-muted border-bottom pb-3">
                                        <div class="col-auto"><i class="far fa-clock me-1"></i> Tập trung:
                                            <?= $lt['GioTapTrung'] ?></div>
                                        <div class="col-auto">|</div>
                                        <div class="col-auto"><i class="fas fa-play me-1"></i> Xuất phát:
                                            <?= $lt['GioXuatPhat'] ?></div>
                                        <div class="col-auto">|</div>
                                        <div class="col-auto"><i class="fas fa-stop me-1"></i> Kết thúc:
                                            <?= $lt['GioKetThuc'] ?></div>
                                    </div>

                                    <div class="mb-3">
                                        <div class="service-tag"><i class="fas fa-hotel me-1"></i>
                                            <?= htmlspecialchars($khachsan) ?></div>
                                        <div class="service-tag"><i class="fas fa-utensils me-1"></i>
                                            <?= htmlspecialchars($nhahang) ?></div>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="session-box session-morning">
                                                <div class="fw-bold text-warning small mb-1"><i class="fas fa-sun me-1"></i>
                                                    BUỔI SÁNG</div>
                                                <?php if (!empty($sang)) : ?>
                                                    <ul class="mb-0 ps-3 small text-secondary">
                                                        <?php foreach ($sang as $line) : ?><li><?= htmlspecialchars($line) ?></li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                <?php else : ?><span class="small text-muted italic">Không có hoạt
                                                        động</span><?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="session-box session-noon">
                                                <div class="fw-bold text-danger small mb-1"><i class="fas fa-utensils me-1"></i>
                                                    BUỔI TRƯA</div>
                                                <?php if (!empty($trua)) : ?>
                                                    <ul class="mb-0 ps-3 small text-secondary">
                                                        <?php foreach ($trua as $line) : ?><li><?= htmlspecialchars($line) ?></li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                <?php else : ?><span class="small text-muted italic">Không có hoạt
                                                        động</span><?php endif; ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="session-box session-afternoon">
                                                <div class="fw-bold text-primary small mb-1"><i
                                                        class="fas fa-cloud-sun me-1"></i> BUỔI CHIỀU</div>
                                                <?php if (!empty($chieu)) : ?>
                                                    <ul class="mb-0 ps-3 small text-secondary">
                                                        <?php foreach ($chieu as $line) : ?><li><?= htmlspecialchars($line) ?></li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                <?php else : ?><span class="small text-muted italic">Không có hoạt
                                                        động</span><?php endif; ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="session-box session-evening">
                                                <div class="fw-bold text-info small mb-1"><i class="fas fa-moon me-1"></i> BUỔI
                                                    TỐI</div>
                                                <?php if (!empty($toi)) : ?>
                                                    <ul class="mb-0 ps-3 small text-secondary">
                                                        <?php foreach ($toi as $line) : ?><li><?= htmlspecialchars($line) ?></li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                <?php else : ?><span class="small text-muted italic">Không có hoạt
                                                        động</span><?php endif; ?>
