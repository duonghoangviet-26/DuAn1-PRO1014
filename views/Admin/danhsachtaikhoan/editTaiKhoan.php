    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h3 class="fw-bold text-dark mb-0">Cập Nhật Tài Khoản</h3>
                    <p class="text-muted mb-0">Chỉnh sửa thông tin đăng nhập</p>
                </div>
            </div>

            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <form action="index.php?act=postEditTaiKhoan" method="POST" class="card card-form" novalidate onsubmit="return validateForm(event)">
                        <input type="hidden" name="MaTaiKhoan" value="<?= $tk['MaTaiKhoan'] ?>">
                        
                        <div class="card-header-custom">
                            <h5 class="fw-bold text-warning mb-0"><i class="fas fa-user-edit me-2"></i> Thông Tin Tài Khoản</h5>
                        </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted fst-italic">Chỉ nhập nếu bạn muốn thay đổi mật khẩu.</small>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Vai Trò <span class="text-danger">*</span></label>
                                <select class="form-select" name="VaiTro">
                                    <option value="admin" <?= $tk['VaiTro'] == 'admin' ? 'selected' : '' ?>>Admin (Quản trị viên)</option>
