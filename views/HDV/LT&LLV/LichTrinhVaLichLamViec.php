...
<body>
    ...
    <div class="sidebar">
        ...
        <<<<<<< HEAD <a href="index.php?act=hdv_schedule" class="active"><i class="fa-solid fa-calendar-days"></i> Lịch
            trình & Lịch
            làm việc</a>
            =======
            <a href="index.php?act=hdv_schedule"><i class="fa-solid fa-calendar-days"></i> Lịch trình & Lịch làm
                việc</a>
            >>>>>>> master
            ...
            <hr style="color: #aad;">
            <a href="index.php?act=logout" class="text-danger"><i class="fa-solid fa-right-from-bracket"></i> Đăng
                xuất</a>
    </div>
